...
2. 为实体建表
   ...
   relation表：通过关系表中rowKey可以确定用户的关注关系；

   ![relation](G:\Git_Repository\BigData\Hbase\assets\1560934183205.png)

   weibo表：

   ![weibo](G:\Git_Repository\BigData\Hbase\assets\1560934877847.png)

   inbox表：减少数据的冗余，以weiboId作为列名，通过版本控制访问微博数量

   ![inbox](G:\Git_Repository\BigData\Hbase\assets\1560934779110.png)

### 2 [代码实现](https://github.com/Dang-h/HBase_Weibo)
